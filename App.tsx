        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-cyber-cyan font-bold tracking-[0.2em] text-sm font-mono">LABS</span>
            </div>
          </div>
          
          <div className="hidden md:flex gap-8 items-center font-mono text-sm tracking-wide">
            <a href="#about" className="hover:text-cyber-cyan transition-colors hover:shadow-[0_0_8px_rgba(0,243,255,0.5)]">[ O NAS ]</a>
            <a href="#threats" className="hover:text-cyber-red transition-colors hover:shadow-[0_0_8px_rgba(255,42,42,0.5)]">[ ZAGROŻENIA ]</a>
            <a href="#workshops" className="hover:text-cyber-green transition-colors hover:shadow-[0_0_8px_rgba(0,255,65,0.5)]">[ WARSZTATY ]</a>
      ...
      <section id="workshops" className="py-24 relative z-10 border-t border-cyber-green/20 bg-black">
        ...
        <div className="container mx-auto px-4">
           <div className="grid lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="relative">
                <TerminalWindow title="workshop_schedule.exe" variant="success" className="border-cyber-green/30 shadow-[0_0_50px_rgba(0,255,65,0.1)]">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.tiktok.com/@_safe_labs" className="flex-1 h-14 border border-white/20 flex items-center justify-center rounded hover:bg-white hover:text-black hover:border-white transition-all group font-bold">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.2" className="w-6 h-6 group-hover:scale-110 transition-transform" stroke="currentColor">
